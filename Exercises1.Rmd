...
knitr::kable(c("min_k=25", "min_rmse=7950.602"))
```

From the above result, the optimal K is 25 because of the minimum RMSE on it. The prediction is in the following.

```{r, echo=FALSE,out.width ="70%", out.height = "70%",fig.align='center'}
knn25 = knnreg(price ~ mileage, data=data1, k=25)
data350_test = data350_test %>%
 mutate(price_pred1 = predict(knn25, data350_test))
...
knitr::kable(c("min_k=15", "min_err=9845.729"))
```
...
knitr::kable(c("min_k=17", "rmse=10805.82"))
```
...
knitr::kable(c("min_k=13", "min_err=20462.65"))
```
